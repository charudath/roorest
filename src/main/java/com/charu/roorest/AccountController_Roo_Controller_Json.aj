...
import com.charu.roorest.AccountController;
...
privileged aspect AccountController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> AccountController.showJson(@PathVariable("id") Integer id) {
    ...
    public ResponseEntity<String> AccountController.deleteFromJson(@PathVariable("id") Integer id) {
        Account account = Account.findAccount(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (account == null) {
