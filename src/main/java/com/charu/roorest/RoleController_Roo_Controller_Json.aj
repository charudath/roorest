...
import com.charu.roorest.RoleController;
...
privileged aspect RoleController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> RoleController.showJson(@PathVariable("id") Integer id) {
    ...
    public ResponseEntity<String> RoleController.deleteFromJson(@PathVariable("id") Integer id) {
        Role role = Role.findRole(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (role == null) {
